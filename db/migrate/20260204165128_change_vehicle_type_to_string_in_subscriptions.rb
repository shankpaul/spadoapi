class ChangeVehicleTypeToStringInSubscriptions < ActiveRecord::Migration[8.0]
  def up
    # Change vehicle_type from integer to string
    change_column :subscriptions, :vehicle_type, :string
  ...
  def down
    ...
    change_column :subscriptions, :vehicle_type, :integer, using: 'vehicle_type::integer'
  end
end
